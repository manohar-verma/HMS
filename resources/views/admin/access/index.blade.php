...
<body>
    <div class="main-wrapper">
        ...
        <!-- -------------------------------------------------------------- -->
        <?php
				if(Cookie::get('remember_admin_admin')){
				  $checked = 'checked';
				  $Username = Cookie::get('remember_admin_username');
				  $Password = Cookie::get('remember_admin_password');
				}
				else{
				  $checked = '';
				  $Username = '';
                    ...
                    <div class="row">
                        <div class="col-12">
                            <form class="form-horizontal mt-3 form-material" id="loginform"
                                action="{{ADMIN_URL}}/do-auth" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="d-flex">
                                        <div class="checkbox checkbox-info pt-0">
                                            <input id="rememberme" name="rememberme"  type="checkbox"
                                                class="material-inputs chk-col-indigo" {{$checked}}>
