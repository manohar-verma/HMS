        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="card-subtitle mb-3 border-bottom pb-3">Add Amenities</h5>
                    <form id="addEditForm" class="form" action="{{ADMIN_URL}}/amenities" method="POST" enctype="multipart/form-data">
