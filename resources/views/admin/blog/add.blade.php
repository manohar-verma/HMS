        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="card-subtitle mb-3 border-bottom pb-3">Add Blogs</h5>
                    <form id="addEditForm" class="form" action="{{ADMIN_URL}}/blog" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <select class="form-select col-12" id="author" name="author">
                                ...
                                <option value="{{$teams->id}}">{{$teams->first_name}} {{$teams->last_name}}</option>
                                @endforeach
                       ...
                       <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                            <textarea class="form-control" rows="10" name="short_description" id="short_description"  rows="10" data-sample="2"placeholder="Description"></textarea>
                            </div>
                        </div>
                        <div class="mb-3 row">
                       ...
                       <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                            <textarea class="form-control" rows="10" name="meta_description" id="meta_description"  rows="10" data-sample="2"placeholder="Description"></textarea>
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="card-body border-top">
                            ...
                            <button type="button" class="btn btn-danger rounded-pill px-4 ms-2 text-white" onclick="window.location.href='{{ADMIN_URL}}/menu'">Cancel</button>
                        </div>
                           </div>
                    </form>
                </div>
    ...
    $('.datepicker').datepicker({format:'dd-mm-yyyy'});
     $(function(){
        $('#addEditForm').submit(function(){
            ...
            if ($('#title').commonCheck() & $('#short_description').commonCheck() & $('#author').commonCheck() & $('#category').commonCheck() & $('#date').commonCheck()) 
            {
                if ($('#image').commonCheck()) 
                {
