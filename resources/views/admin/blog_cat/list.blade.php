        ...
        <div class="card card-body">
            <div class="row">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-success rounded-pill px-4"><span
                                            ...
                                            <button type="button" onclick="window.location='{{ADMIN_URL}}/blog-cat'"
                ...
                <div
                    ...
                    <a href="{{ADMIN_URL}}/blog-cat/create" id="btn-add-contact" class="btn btn-info">
        ...
        <div class="card card-body">
            <div class="table-responsive">
                <table class="table search-table v-middle">
                    ...
                    <th style="cursor:pointer;width:10% ;" onClick="handleFilter('id','{{$nextSortDirection}}','{{$currentSortFiled}}');">Sl No @if($currentSortFiled=='id') <i class="bi-caret-{{$currentSortDirection}}-square-fill" ></i> @endif</th>
                    <th style="cursor:pointer;width:80% ;" onClick="handleFilter('name','{{$nextSortDirection}}','{{$currentSortFiled}}');">Name @if($currentSortFiled=='name') <i class="bi-caret-{{$currentSortDirection}}-square-fill" ></i> @endif</th>
                        ...
                        <tr class="search-items">
                            ...
                            <td>
                                ...
                                <div class="action-btn">
                                    <a href="{{ADMIN_URL}}/blog-cat/{{$listitem->id}}/edit" class="text-info edit"><i data-feather="edit"
                                            class="feather-sm fill-white"></i></a>
                                    <a href="{{ADMIN_URL}}/blog-cat/delete/{{$listitem->id}}" class="text-dark  ms-2" onclick="return confirm('Are you sure to delete?');"><i data-feather="trash-2"
                                            class="feather-sm fill-white"></i></a>
...
<script type="text/javascript">
  ...
  $(document).on('click','.changeStatus',function(){
	  ...
	  $.ajax({
		  type: "POST",
		  url: "{{ADMIN_URL}}/blog-cat/changeStatus/"+id,
			data: { _token : _token },
