        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="card-subtitle mb-3 border-bottom pb-3">Edit Hotel</h5>
                    <form id="addEditForm" class="form" action="{{ADMIN_URL}}/hotel/{{$hotelData->hotel_id}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                     ...
                     <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                            <textarea class="form-control " rows="10" name="description" id="description"  rows="10" data-sample="2"placeholder="Description">{{$hotelData->description}}</textarea>
                            </div>
                        </div>
                     <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <select class="form-select col-12 " id="country" name="country">
                                ...
                                <option value="{{$count->id}}" @if($hotelData->country == $count->id) selected @endif>{{$count->country_name}}</option>
                                @endforeach
                                @endif
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <select class="form-select col-12 " id="state" name="state">
                                ...
                                <option value="{{$sta->id}}" @if($hotelData->state == $sta->id) selected @endif>{{$sta->state_name}}</option>
                                @endforeach
                                @endif
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" placeholder="City"
                                id="city" name="city" rows="3" cols="3" class="form-control "
                       ...
                       <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                             <input class="form-control allow_numeric" type="text" placeholder="Zip Code"
                                id="zip_code" name="zip_code" rows="3" cols="3" class="form-control "
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control allow_numeric" type="text" 
                                    id="phone" name="phone" rows="3" cols="3" class="form-control "
                       ...
                       <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control email" type="text" 
                                    id="email" name="email" rows="3" cols="3" class="form-control "
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" 
                                    id="star_rating" name="star_rating" rows="3" cols="3" class="form-control "
