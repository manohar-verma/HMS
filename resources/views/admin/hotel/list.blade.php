        ...
        <div class="card card-body">
            <div class="row">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-success rounded-pill px-4"><span
                                            ...
                                            <button type="button" onclick="window.location='{{ADMIN_URL}}/hotel'"
                ...
                <div
                    ...
                    <a href="{{ADMIN_URL}}/hotel/create" id="btn-add-contact" class="btn btn-info">
        ...
        <div class="card card-body">
            <div class="table-responsive">
                <table class="table search-table v-middle">
                    ...
                    <th style="cursor:pointer;" onClick="handleFilter('name','{{$nextSortDirection}}','{{$currentSortFiled}}');">Name @if($currentSortFiled=='name') <i class="bi-caret-{{$currentSortDirection}}-square-fill" ></i> @endif</th>
                    <th>Email</th>
                    <th>Phone</th>
                    <th>City</th>
                    <th>State</th>
                        ...
                        <tr class="search-items">
                            ...
                            <td>
                                ...
                                <div class="action-btn">
                                    <a href="{{ADMIN_URL}}/hotel/{{$listitem->hotel_id}}/edit" class="text-info edit"><i data-feather="edit"
                                            class="feather-sm fill-white"></i></a>
                                    <a href="{{ADMIN_URL}}/hotel/delete/{{$listitem->hotel_id}}" class="text-dark  ms-2" onclick="return confirm('Are you sure to delete?');"><i data-feather="trash-2"
                                            class="feather-sm fill-white"></i></a>
                                    <a href="javascript:void(0)" class="changeStatus" id="changeStatus{{$listitem->hotel_id}}" data-id="{{$listitem->hotel_id}}">{!!$StatusHtml!!}</a>        
                                </div>
                            </td>
                        </tr>
                        @endforeach
