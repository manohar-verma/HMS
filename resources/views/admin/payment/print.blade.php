...
<html class="no-js" lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <link rel="stylesheet" href="{{SITE_URL}}/assets/admin/css/styleInvoice.css">
</head>
  ...
  <div class="cs-container">
    <div class="cs-invoice cs-style1">
      <div class="cs-invoice_in" id="download_section">
        <div class="cs-invoice_head cs-type1 cs-mb25">
          ...
          <div class="cs-invoice_right cs-text_right">
            <div class="cs-logo cs-mb5"><img src="{{SITE_URL}}/assets/admin/images/logo.png" alt="Logo" style="width: 10%;"></div>
          </div>
        </div>
      ...
      <div class="cs-invoice_btns cs-hide_print">
        ...
        <a href="{{ADMIN_URL}}/invoices" class="cs-invoice_btn cs-color1">
...
<script src="{{SITE_URL}}/assets/admin/js/printInvoice/jquery.min.js"></script>
<script src="{{SITE_URL}}/assets/admin/js/printInvoice/jspdf.min.js"></script>
<script src="{{SITE_URL}}/assets/admin/js/printInvoice/html2canvas.min.js"></script>
<script src="{{SITE_URL}}/assets/admin/js/printInvoice/main.js"></script>
</body></html>