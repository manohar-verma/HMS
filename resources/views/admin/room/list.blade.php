        ...
        <div class="card card-body">
            <div class="row">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-success rounded-pill px-4"><span
                                            ...
                                            <button type="button" onclick="window.location='{{ADMIN_URL}}/room'"
                ...
                <div
                    ...
                    <a href="{{ADMIN_URL}}/room/create" id="btn-add-contact" class="btn btn-info">
        ...
        <div class="card card-body">
            <div class="table-responsive">
                <table class="table search-table v-middle">
                    ...
                    <th style="cursor:pointer;" onClick="handleFilter('id','{{$nextSortDirection}}','{{$currentSortFiled}}');">Sl No @if($currentSortFiled=='room_id') <i class="bi-caret-{{$currentSortDirection}}-square-fill" ></i> @endif</th>
                    ...
                    <tbody>
                        ...
                        <tr class="search-items">
                            ...
                            <td>
                                 {{$listitem->get_hotel->name}}
                            </td>
                            <td>
                                {{$listitem->room_number}} 
                            </td>
                             <td>
                                 {{$listitem->get_type->title}}
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <div class="action-btn">
                                    <a href="{{ADMIN_URL}}/room/{{$listitem->room_id}}/edit" class="text-info edit"><i data-feather="edit"
                                            class="feather-sm fill-white"></i></a>
                                    <a href="{{ADMIN_URL}}/room/delete/{{$listitem->room_id}}" class="text-dark  ms-2" onclick="return confirm('Are you sure to delete?');"><i data-feather="trash-2"
                                            class="feather-sm fill-white"></i></a>
