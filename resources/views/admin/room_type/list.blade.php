        ...
        <div class="card card-body">
            <div class="row">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-success rounded-pill px-4"><span
                                            ...
                                            <button type="button" onclick="window.location='{{ADMIN_URL}}/room-type'"
                ...
                <div
                    ...
                    <a href="{{ADMIN_URL}}/room-type/create" id="btn-add-contact" class="btn btn-info">
                        ...
                        <tr class="search-items">
                            ...
                            <td>
                                ...
                                <div class="action-btn">
                                    <a href="{{ADMIN_URL}}/room-type/{{$listitem->type_id}}/edit" class="text-info edit"><i data-feather="edit"
                                            class="feather-sm fill-white"></i></a>
                                    <a href="{{ADMIN_URL}}/room-type/delete/{{$listitem->type_id}}" class="text-dark  ms-2" onclick="return confirm('Are you sure to delete?');"><i data-feather="trash-2"
                                            class="feather-sm fill-white"></i></a>
...
<script type="text/javascript">
 ...
 $(document).on('click','.changeStatus',function(){
	  ...
	  $.ajax({
		  type: "POST",
		  url: "{{ADMIN_URL}}/room-type/changeStatus/"+id,
			data: { _token : _token },
