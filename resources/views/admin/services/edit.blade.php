        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="card-subtitle mb-3 border-bottom pb-3">Edit </h5>
                    <form id="addEditForm" class="form" action="{{ADMIN_URL}}/services/{{$servicesData->id}}" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="_token" value="{{ Session::token() }}">
                     ...
                     <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                            <textarea class="form-control" rows="10" name="description" id="description"  rows="10" data-sample="2"placeholder="Description">{!!$servicesData->description!!}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control allow_numeric" type="text" name="display_order" id="display_order"
                                    value="{{$servicesData->display_order}}" placeholder="Display Order">
                            </div>
                     </div>
                     <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <input class="form-control" type="text" name="icon_class" id="icon_class"
                                    value="{{$servicesData->icon_class}}" placeholder="Icon Class">
                            </div>
                     </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <div class="form-check">
                                    <input type="radio" id="Active" name="status" class="form-check-input" value="1" @if($servicesData->status==1) checked="true" @endif>
                                    <label class="form-check-label" for="Active">Active</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" id="Deactivate" name="status" class="form-check-input" value="0" @if($servicesData->status==0) checked="true" @endif>
