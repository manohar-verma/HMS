        ...
        <div class="card card-body">
            <div class="row">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append" style="margin-left: 5px;">
                                        <button type="submit" class="btn btn-success rounded-pill px-4"><span
                                            ...
                                            <button type="button" onclick="window.location='{{ADMIN_URL}}/services'"
                ...
                <div
                    ...
                    @if($accessAddNew)
                    <a href="{{ADMIN_URL}}/services/create" id="btn-add-contact" class="btn btn-info">
                        ...
                        <tr class="search-items">
                            ...
                            <td>
                              @if($listitem->status == 1)
                                ...
                                @if($accessUpdate)
                                    <a href="{{ADMIN_URL}}/services/{{$listitem->id}}/edit" class="text-info edit"><i data-feather="edit"
                                            class="feather-sm fill-white"></i></a>
                                @endif 
                                @if($accessDelete)              
                                    <a href="{{ADMIN_URL}}/services/delete/{{$listitem->id}}" class="text-dark  ms-2" onclick="return confirm('Are you sure to delete?');"><i data-feather="trash-2"
                                            class="feather-sm fill-white"></i></a>
                                @endif
                                @if($accessUpdate)          
...
<script type="text/javascript">
  ...
  $(document).on('click','.changeStatus',function(){
	  ...
	  $.ajax({
		  type: "POST",
		  url: "{{ADMIN_URL}}/services/changeStatus/"+id,
			data: { _token : _token },
