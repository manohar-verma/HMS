        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="card-subtitle mb-3 border-bottom pb-3">Edit Feedback</h5>
                    <form id="addEditForm" class="form" action="{{ADMIN_URL}}/testimonials/{{$testimonialData->id}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                            <textarea class="form-control" rows="10" name="description" id="description"  rows="10" data-sample="2"placeholder="Description">{{$testimonialData->description}}</textarea>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="image" class="col-md-2 col-form-label"></label>
                            <div class="col-md-10">
                            <img src="{{url('/')}}/upload/testimonial/thumb/{{$testimonialData->image}}"alt="user" />
                            </div>
                        </div> 
                        <div class="mb-3 row"> 
                        <label for="image" class="col-md-2 col-form-label">Image {!!REQUIRED_STAR!!}</label>
                        <div class="col-md-10">
                        <input class="form-control" type="file" name="image" id="image" value="{{$testimonialData->image}}">
                        </div>
                       ...
                       <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{$testimonialData->alt_tag}}"
                                id="alt_tag" name="alt_tag" rows="3" cols="3" class="form-control" >
                        </div>
                        </div>
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{$testimonialData->client_name}}"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-10">
                                <div class="form-check">
                                    <input type="radio" id="Active" name="status" class="form-check-input" value="1" @if($testimonialData->status == '1') checked="true" @endif>
                                    <label class="form-check-label" for="Active">Active</label>
                                </div>
                                <div class="form-check">
                                    <input type="radio" id="Deactivate" name="status" class="form-check-input" value="0" @if($testimonialData->status == '0') checked="true" @endif>
...
<script>
     $(function(){
        ...
        $('#addEditForm').submit(function(){
            ...
            if ($('#title').commonCheck() & $('#client_name').commonCheck() & $('#alt_tag').commonCheck()) 
            {
                
                if($('#image').val() & $('#image').checkFileType({
                        blankCk: false,
