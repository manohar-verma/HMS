        ...
        <div class="card card-body">
            <div class="row">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-success rounded-pill px-4"><span
                                            ...
                                            <button type="button" onclick="window.location='{{ADMIN_URL}}/testimonials'"
                ...
                <div
                    ...
                    <a href="{{ADMIN_URL}}/testimonials/create" id="btn-add-contact" class="btn btn-info">
            ...
            <div class="table-responsive">
                <table class="table search-table v-middle">
                    <thead class="header-item">
                        ...
                        <th style="width:20%;">Star Rate</th>
                    ...
                    <tbody>
                        ...
                        <tr class="search-items">
                            ...
                            <td>
                            <img src="{{url('/')}}/upload/testimonial/thumb_crop/{{$listitem->image}}"alt="user" />
                            </td>
                            <td>
                                 {{$listitem->alt_tag}}
                            </td>
                            ...
                            <td>
                                ...
                                <div class="action-btn">
                                    <a href="{{ADMIN_URL}}/testimonials/{{$listitem->id}}/edit" class="text-info edit"><i data-feather="edit"
                                            class="feather-sm fill-white"></i></a>
                                    <a href="{{ADMIN_URL}}/testimonials/delete/{{$listitem->id}}" class="text-dark  ms-2" onclick="return confirm('Are you sure to delete?');"><i data-feather="trash-2"
                                            class="feather-sm fill-white"></i></a>
...
<script type="text/javascript">
  ...
  $(document).on('click','.changeStatus',function(){
	  ...
	  $.ajax({
		  type: "POST",
		  url: "{{ADMIN_URL}}/testimonials/changeStatus/"+id,
			data: { _token : _token },
