                ...
                <form action="" method="GET" id="searchForm">
                            ...
                            <div class="input-group footable-filtering-search">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control " name="phone" placeholder="By Phone" value="{{Input::get('phone')}}" style="margin-left: 5px;">
                        ...
                        <tr class="search-items">
                            ...
                            <td>
                              @if($listitem->status == 1)
                                ...
                                @endif 
                                @if($accessDelete)              
                                    <a href="{{ADMIN_URL}}/users/delete/{{$listitem->id}}" class="text-dark  ms-2" onclick="return confirm('Are you sure to delete?');"><i data-feather="trash-2"
                                            class="feather-sm fill-white"></i></a>
                                @endif
                                @if($accessUpdate)          
...
<script type="text/javascript">
  ...
  $(document).on('click','.changeStatus',function(){
	  ...
	  $.ajax({
		  type: "POST",
		  url: "{{ADMIN_URL}}/users/changeStatus/"+id,
			data: { _token : _token },
